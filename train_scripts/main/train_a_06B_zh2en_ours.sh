...
mul_times=1
model_tag="Qwen3-0.6B-main_zh2en_ours"
exp_name="bs@${train_batch_size}_n@${rollout_num}_m@${mul_times}_@${datetime}_@${model_tag}_@${num_gpus}gpus"
dir=./data

train_file_path="[$dir/train/train_mixed_zh_CN-en.parquet]"
test_file_path="[$dir/test/wmt24_zh_CN-en.parquet,$dir/test/challenge_set_zh_CN-en.parquet,$dir/test/flores_zh2en.parquet]"
